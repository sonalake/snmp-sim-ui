...
import { mockDevices } from '../../utils/__mocks__/mockDevices';
...
describe('Devices', () => {
  ...
  xit('should render the table rows', async () => {
    renderWithRouter(<Devices />);
    expect(await screen.findByText('No data to display')).toBeInTheDocument();
  });

  xit('should show left panel and selection of device and status working', async () => {
    renderWithRouter(<Devices />);
